...
namespace Sitefinity_CLI.Commands
{
	...
	internal abstract class CommandBase
	{
		...
		private List<string> _extensionSkipList = new List<string> { ".sf-cshtml", ".cshtml", ".json", ".directives", ".md", ".sf-cshtml" };
		...
		protected void AddSignToFile(string filePath)
		{
			...
			if (!_extensionSkipList.Any(skipExt => skipExt == fileExtension))//skip these extensions as they do not have 'commenting' or placing on the first line is bad practice
			{
